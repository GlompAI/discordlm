            ...
            if (fetchedMessage) {
                if (fetchedMessage.webhookId) {
                    ...
                    if (character && webhookManager) {
                        const contentToKeep = fetchedMessage.content.replace(
                            /\n\[Generated by .*?\]\(https:\/\/a\.a\/.*\)/s,
                            "",
                        );
                        await webhookManager.editAsCharacter(fetchedMessage, character, contentToKeep, {
            ...
            if (fetchedMessage) {
                if (fetchedMessage.webhookId) {
                    ...
                    if (character && webhookManager) {
                        ...
                        const finalContent = contentToKeep.replace(/\n\n> Generating.../, "");
